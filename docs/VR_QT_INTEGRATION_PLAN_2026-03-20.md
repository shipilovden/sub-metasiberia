...
- The XR world anchor currently carries a user-tuned negative vertical trim relative to the desktop eye anchor so the worn headset lands lower in-world; this trim should remain easy to adjust while live headset alignment is being dialed in.
